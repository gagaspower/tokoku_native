...
?> 
                <!-- <div class="col-md-6 col-sm-12"> -->
                    ...
                    <div class="thumbnail">
                        <a href="<?php echo BASE_URL;?>/<?php echo $r['judul_seo'];?>/">
                        ...
                        <div class="caption">
                            <h1><a href="<?php echo BASE_URL;?>/<?php echo $r['judul_seo'];?>/"><?php echo $r['judul'];?></a></h1>
                            <p class="by-author">
                            ...
                            <p>
                                <a href="<?php echo BASE_URL;?>/<?php echo $r['judul_seo'];?>/" class="btn btn-primary btn-sm" role="button">Selengkapnya <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                            </p>
                        </div>
                    </div>
                </div>
