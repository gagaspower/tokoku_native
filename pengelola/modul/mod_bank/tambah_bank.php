...
<div class="box-header with-border">
  <h3 class="box-title">Tambah Master Bank</h3>
</div>
<form action="?modul=aksibank&act=simpan" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row">
            <div class="col-md-9">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="nama_bank" required="required">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="rek_bank" required="required">
                </div>
              </div>
             </div>
        </div>
