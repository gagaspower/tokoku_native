...
<form action="?modul=aksiongkir&act=simpan" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="col-md-9">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%; height: 34px;" name="kabupaten_id">
                  ...
                  ?>
                  <option value="<?php echo $p['id'];?>"><?php echo $p['nama_kabupaten'];?></option>
                  <?php } ?>
                </select>
              </div>
              </div>
              <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%; height: 34px;" name="ekspedisi_id">
                  ...
                  while($p=mysql_fetch_array($sql)){
                  ?>
                  <option value="<?php echo $p['id'];?>"><?php echo $p['nama_ekspedisi'];?></option>
                  <?php } ?>
                </select>
              </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="number" min="0" class="form-control" name="ongkos" required="required">
                </div>
              </div>
             </div>
        </div>
