...
<?php
$sql = mysql_query("SELECT * FROM download WHERE id = '".$val->validasi($_GET['id'],'sql')."'");
$r = mysql_fetch_array($sql);
?>
<form action="?modul=aksifile&act=edit" method="post" enctype="multipart/form-data" class="form-horizontal">
